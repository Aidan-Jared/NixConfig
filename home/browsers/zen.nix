...
let
  # Helper: looks up an extension's short ID on addons.mozilla.org (the slug in the URL),
  # and its GUID from https://addons.mozilla.org/api/v5/addons/addon/<shortId>/
