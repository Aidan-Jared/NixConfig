{self, inputs, ...}:
{
  flake.wrappersModules.noctalia = { config, lib, pkgs, ... }: {
    package = inputs.noctalia.homeModules.${pkgs.stdenv.hostPlatform.system}.default;
     env = {
